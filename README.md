...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/Olipro/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/Olipro/oh-my-zsh/master/tools/install.sh -O -)"
```
...
Oh My Zsh comes with a shitload of plugins to take advantage of. You can take a look in the [plugins](https://github.com/Olipro/oh-my-zsh/tree/master/plugins) directory and/or the [wiki](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins) to see what's currently available.
...
```shell
export ZSH="$HOME/.dotfiles/oh-my-zsh"; sh -c "$(curl -fsSL https://raw.githubusercontent.com/Olipro/oh-my-zsh/master/tools/install.sh)"
```
...
This is a fork, use it at your own risk.
