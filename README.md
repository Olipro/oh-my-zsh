...
```shell
sh -c "$(wget -O- https://raw.githubusercontent.com/Olipro/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
curl -Lo install.sh https://raw.githubusercontent.com/Olipro/oh-my-zsh/master/tools/install.sh
sh install.sh
```
