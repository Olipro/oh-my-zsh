...
`curl -L https://raw.github.com/Olipro/oh-my-zsh/master/tools/install.sh | sh`

#### via wget

`wget https://raw.github.com/Olipro/oh-my-zsh/master/tools/install.sh -O - | sh`

## Using Oh My Zsh

### Plugins

Oh My Zsh comes with a shit load of plugins to take advantage of. You can take a look in the [plugins](https://github.com/Olipro/oh-my-zsh/tree/master/plugins) directory and/or the [wiki](https://github.com/Olipro/oh-my-zsh/wiki/Plugins) to see what's currently available.
...
We'll admit it. Early in the Oh My Zsh world... we may have gotten a far too theme happy. We have over one hundred themes now bundled. Most of them have [screenshots](https://wiki.github.com/Olipro/oh-my-zsh/themes) on the wiki. Check them out!
...
`curl -L https://raw.github.com/Olipro/oh-my-zsh/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh`

#### Manual Installation

##### 1. Clone the repository:

`git clone git://github.com/Olipro/oh-my-zsh.git ~/.oh-my-zsh`
...
We also need people to test out pull-requests. So take a look through [the open issues](https://github.com/Olipro/oh-my-zsh/issues) and help where you can.
...
Oh My Zsh is released under the [MIT license](https://github.com/Olipro/oh-my-zsh/blob/master/MIT-LICENSE.txt).
