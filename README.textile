...
@curl -L https://github.com/Olipro/oh-my-zsh/raw/master/tools/install.sh | zsh@

@wget --no-check-certificate https://github.com/Olipro/oh-my-zsh/raw/master/tools/install.sh -O - | zsh@
