...
# or via wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/Olipro/oh-my-zsh/master/tools/install.sh)"
# or via fetch:
#   sh -c "$(fetch -o - https://raw.githubusercontent.com/Olipro/oh-my-zsh/master/tools/install.sh)"
#
...
#   REPO    - name of the GitHub repo to install from (default: Olipro/oh-my-zsh)
